...
public class eindopdracht2 {
    ...
    private static PersonenSQLHandler sqlHandler;
    private static int clickedIndex = -1;

    public static void main(String[] args) {
       loadFrame();
       sqlHandler = new PersonenSQLHandler();
       persoonOverzicht();
    }
    ...
    private static void persoonOverzicht(){
        ...
        //Maak de JList aan.
        DefaultListModel<String> model = sqlHandler.laadPersonen();
        ...
        deleteButton.addActionListener(e -> {
            sqlHandler.verwijderPersoon(clickedIndex);
    ...
    private static void editMenu(){
        ...
        button.addActionListener(e -> {
            ...
            if(!invalidInput) {
                ...
                sqlHandler.voegPersoonToe(new Persoon(voornaamField.getText(), achternaamField.getText()));
                frame.getContentPane().removeAll();
                frame.repaint();
                persoonOverzicht();
            } else {
